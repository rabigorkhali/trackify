...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" action="{{ route('newsletter-subscriptions.update', $thisData->id) }}" method="post"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input  value="{{ $thisData->title ?? '' }}" type="text" name="title" id="title" min="3"
                    ...
                    <div class="col-md-6">
                        <label class="form-label" for="title">{{ __('Email') }}</label> *
                        <input required value="{{ $thisData->email??old('email') }}" type="text" name="email" id="email"

                ...
                <div class="card-datatable table-responsive">
                    <form method="get" action="{{ route('newsletter-subscriptions.index') }}">
                        <div class="dataTables_wrapper dt-bootstrap5 no-footer">
                                        ...
                                        <div class="dt-buttons btn-group flex-wrap">
                                            <div class="btn-group">
                                                ...
                                                @if(hasPermission('/'.str_replace(' ','-',strtolower($title)),'post'))
                                                    <a class="btn add-new btn-primary text-white" href="{{ route('newsletter-subscriptions.create') }}">
                            ...
                            <table class="datatables-newsletter-subscriptions table dataTable no-footer dtr-column" id="DataTables_Table_0">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        @if(hasPermission('/'.str_replace(' ','-',strtolower($title)).'/*','put'))
                                                            <a class="dropdown-item" href="{{ route('newsletter-subscriptions.edit', $post->id) }}">
                                                                <i class="ti ti-pencil me-1"></i>{{ __('Edit') }}
                                                            </a>
                                                        @endif
                                                        @if(hasPermission('/'.str_replace(' ','-',strtolower($title)).'/*','delete'))
                                                            <a href="#" class="dropdown-item delete-button" data-bs-toggle="modal" data-actionurl="{{ route('newsletter-subscriptions.destroy', $post->id) }}" data-bs-target="#deleteModal">

            ...
            <form class="card-body" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="country" class="form-control  @if ($errors->first('country')) is-invalid @endif">
                            ...
                            @foreach (config('countries') as $countryCode => $countryName)
                                <option @if (old('country') == $countryCode) selected @endif value="{{ $countryCode }}">
                                    {{ $countryName }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ old('date_of_birth') }}" type="date" name="date_of_birth" id="date_of_birth"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @if ($errors->first('gender')) is-invalid @endif" name="gender">
                            ...
                            <option value="male" @if (old('gender') == 'other') selected @endif>{{ __('Other') }}
                            </option>
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <select required class="form-control @if ($errors->first('role_id')) is-invalid @endif"
                            ...
                            @foreach ($roles as $roleDatum)
                                <option @if (old('role_id') == $roleDatum->id) selected @endif value="{{ $roleDatum->id }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <input min="8" required value="{{ old('password') }}" type="password" name="password"
                            id="password" class="form-control @if ($errors->first('password')) is-invalid @endif"

                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input required value="{{ $thisData->name ?? '' }}" type="text" name="name" id="name"
                            min="3" class="form-control @if ($errors->first('name')) is-invalid @endif"
                            placeholder="Name" />
                    ...
                    <div class="col-md-6">
                        ...
                        <input min="10" max="15" value="{{ $thisData->mobile_number ?? '' }}" type="text"
                            name="mobile_number" max="15" id="mobile_number"
                    ...
                    <div class="col-md-6">
                        ...
                        <input value="{{ $thisData->date_of_birth ?? '' }}" type="date" name="date_of_birth"
                            id="date_of_birth" class="form-control @if ($errors->first('date_of_birth')) is-invalid @endif"
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control @if ($errors->first('gender')) is-invalid @endif" name="gender">
                            <option value="">{{ __('None') }}</option>
                            <option value="male" @if ($thisData->gender == 'male') selected @endif>{{ __('Male') }}
                            </option>
                            <option value="female" @if ($thisData->gender == 'female') selected @endif>{{ __('Female') }}
                            </option>
                            <option value="male" @if ($thisData->gender ?? old('gender') == 'other') selected @endif>{{ __('Other') }}
                            </option>
                    ...
                    <div class="col-md-6">
                        ...
                        <select @if ($thisData->id == authUser()->id) disabled @endif required
                            class="form-control @if ($errors->first('role_id')) is-invalid @endif" name="role_id">
                            <option value="">{{ __('None') }}</option>
                            @foreach ($roles as $roleDatum)
                                <option @if ($thisData->role_id == $roleDatum->id) selected @endif value="{{ $roleDatum->id }}">
                                    {{ ucfirst($roleDatum->name) }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check-inline">
                            <input type="radio" id="is_user_verified_by_donatepur0"
                                name="is_user_verified_by_donatepur" value="0"
                                class="form-check-input @if ($errors->first('is_user_verified_by_donatepur')) is-invalid @endif"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check-inline">
                            <input @if ($thisData->id == authUser()->id) disabled @endif id="status1" type="radio"
                                name="status" value="1"
                        ...
                        <div class="form-check-inline">
                            <input @if ($thisData->id == authUser()->id) disabled @endif type="radio" id="status2"
                                name="status" value="0"
                                class="form-check-input @if ($errors->first('status')) is-invalid @endif"
                    ...
                    <div class="col-md-6 mt-4">
                        <a target="_blank" href="{{ asset($thisData?->image) }}">
                            <img src="{{ asset($thisData?->image) }}" width="100" alt="Logo"
                                class="img-fluid"></a>
                    </div>
                    <hr>
                    <div class="col-md-6">

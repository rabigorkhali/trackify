...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" action="{{ route('post-categories.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row g-3">
                    <!-- Title Field -->
                    <div class="col-md-6">
                        <label class="form-label" for="title">{{ __('Name') }}</label> *
                        <input required value="{{ old('name') }}" type="text" name="name" id="title"

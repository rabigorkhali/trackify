            ...
            <form class="card-body" action="{{ route('projects.update', $thisData->id) }}" method="post"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input required value="{{ $thisData->key }}" type="text" name="key" id="key" maxlength="10"
                               class="form-control @if ($errors->first('key')) is-invalid @endif"
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="description" id="description" rows="4"
                                  ...
                                  placeholder="Project Description">{{ $thisData->description }}</textarea>
                        ...
                        @if ($thisData->avatar)
                            <div class="col-md-6 mt-2">
                                <a target="_blank" href="{{ asset($thisData->avatar) }}">
                                    <img src="{{ asset($thisData->avatar) }}" width="100" alt="Avatar" class="img-fluid">
                                </a>
                            </div>
                        @endif
                    </div>

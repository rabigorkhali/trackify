                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        @if(hasPermission('/' . str_replace(' ','-',strtolower($title)) . '/*', 'put'))
                                                            <a class="dropdown-item" href="{{ route('partners.edit', $testimonial->id) }}"><i class="ti ti-pencil me-1"></i>{{ __('Edit') }}</a>
                                                        @endif
                                                        @if(hasPermission('/' . str_replace(' ','-',strtolower($title)) . '/*', 'delete'))
                                                            <a href="#" class="dropdown-item delete-button" data-bs-toggle="modal" data-actionurl="{{ route('partners.destroy', $testimonial->id) }}" data-bs-target="#deleteModal">

...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <form class="card-body" action="{{ route('redirections.store') }}" method="post"
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input required value="{{ old('source_link') }}" type="url" name="source_link" id="source_link"
                    ...
                    <div class="col-md-6">
                        ...
                        <input required value="{{ old('destination_link') }}" type="url" name="destination_link"
                               id="destination_link"
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="redirection_type" id="redirection_type"
                            ...
                            @foreach (getRedirectionType() as $value => $label)
                                <option value="{{ $value }}" {{ old('redirection_type') == $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                            @endforeach
                        </select>

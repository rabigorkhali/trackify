...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><strong>{{ $commenter->name }}</strong> mentioned you in a comment on ticket <strong>{{ $ticket->ticket_key }}</strong>.</p>
            ...
            <div class="comment-box">
                ...
                <p style="color: #718096; font-size: 12px; margin-top: 10px;">
                    - {{ $commenter->name }}, {{ $comment->created_at->diffForHumans() }}
                </p>
            </div>
            ...
            <p style="margin-top: 20px; color: #718096; font-size: 13px;">
                You're receiving this email because you were mentioned in a ticket comment.
            </p>
        </div>
